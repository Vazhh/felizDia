  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-rose-100 via-pink-200 to-rose-300 p-6">
      {!iniciado ? (
        ...
        <div
          className="w-full max-w-2xl h-[80vh] overflow-auto bg-white bg-opacity-80 rounded-3xl shadow-xl p-8 font-romantic text-2xl text-rose-800 leading-relaxed border border-rose-300 backdrop-blur-md scrollbar-none scroll-smooth"
          ref={scrollRef}
        >
          {contenido}
          <span className="animate-pulse text-rose-400">|</span>
